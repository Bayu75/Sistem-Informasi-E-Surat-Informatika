    ...
    >
        ...
        <div class="shrink-0 border-t border-white/10 bg-violet-950/30 p-4">
            <div class="mb-4 flex items-center gap-3">
                ...
                <div>
                    <p class="text-sm font-semibold">Dr. Ahmad Fauzi, M.T.</p>
                    <p class="text-xs text-indigo-100/60">Teknik Informatika</p>
                </div>
            </div>

            <a href="/login" class="text-sm text-indigo-100/70 hover:text-white">
                ↳ Logout
            </a>
        </div>
    </aside>
