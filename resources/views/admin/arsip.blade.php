                    ...
                    <template x-for="item in filteredItems" :key="item.id">
                        <tr class="hover:bg-slate-50 transition">
                            ...
                            <td class="px-5 py-4 flex justify-center text-center">
                                ...
                                <template x-if="item.status == 'disetujui_kaprodi'">
                                    <span class="rounded-full bg-emerald-100 px-3 py-1 text-xs font-semibold text-emerald-700">
                                        Disetujui Kaprod    i
                                    </span>
                                </template>

                                <template x-if="item.status == 'ditolak_kaprodi'">
                ...
                <div class="flex flex-wrap items-center justify-between gap-3">
                    ...
                    <span
                        ...
                        :class="{
                            ...
                            'border-emerald-300 bg-emerald-50 text-emerald-700': selectedItem?.status === 'disetujui_kaprodi',
                            'border-rose-300 bg-rose-50 text-rose-700': selectedItem?.status === 'ditolak_kaprodi',
                        }"
                    >
                ...
                <div class="rounded-2xl bg-slate-50 p-4">
                    ...
                    >
                        ...
                        <p
                            ...
                            x-text="selectedItem?.catatan_admin || 'Tidak ada catatan.'"
                        ></p>
                    </div>

                    {{-- Catatan Kaprodi --}}
                    <div
                        x-show="selectedItem?.status == 'ditolak_kaprodi'"
                        class="rounded-2xl border border-red-200 bg-red-50 p-2 mb-2"
                    >
                        <h4 class="mb-3 flex items-center gap-2 font-semibold text-red-700">
                            <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none">
                        ...
                        <p
                            class="pl-2 text-sm text-red-700 leading-relaxed"
                            x-text="selectedItem?.catatan_admin_kaprodi || 'Tidak ada catatan.'"
                        ></p>
                    </div>
